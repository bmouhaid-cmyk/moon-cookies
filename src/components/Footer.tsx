        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-8">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <p className="text-cream/70 font-sans max-w-xs">
              L'art du cookie artisanal. Fait avec passion, cuit à la perfection pour votre plus grand plaisir.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <ul className="space-y-4 font-sans text-cream/70">
              <li className="flex items-center gap-3">
                ...
                <a href="https://wa.me/212631639229" className="hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">
                  +212 631 639 229
                </a>
              </li>
              <li className="flex items-center gap-3">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <a 
              href="https://www.instagram.com/mooncookies71" 
